...
public class AdminUserController {
    ...
    public ApiResponse<PageResponse<Object>> searchUsers(
            ...
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "20") int size) {
        return userClient.searchUsers(skills, country, city, education, workExperience, employmentTypes, username, page, size);
    }
    ...
    public ApiResponse<Void> deactivateUser(
        ...
        // In a real scenario, we might want to ensure the caller is an admin here or via Gateway.
