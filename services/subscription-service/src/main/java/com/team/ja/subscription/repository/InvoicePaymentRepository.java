...
// @Repository
// public interface InvoicePaymentRepository extends JpaRepository<Invoice,
// UUID> {
...
// /**
// * Check if an invoice payment exists for a given invoice ID and payment
// status.
// */
// boolean existsByInvoiceIdAndPaymentStatus(UUID invoiceId, String
// paymentStatus);

// /**
// * Find invoice payments made within a specific date range.
// */
// List<Invoice> findByPaymentDateBetween(java.time.LocalDate startDate,
