...
public interface UserSubscriptionRepository extends
     ...
     */
    List<UserSubscription> findByUserIdAndSubscriptionStatus(UUID userId, String subscriptionStatus);

    /**
     * Check if an active subscription exists for a user.
     */
    boolean existsByUserIdAndSubscriptionStatus(UUID userId, String subscriptionStatus);
