...
public class UserPortfolioServiceImpl implements UserPortfolioService {
    ...
    private static final List<String> SUPPORTED_MEDIA_TYPES = List.of("image/jpeg", "image/png", "image/gif",
            "video/mp4");
    ...
    private void validateFile(MultipartFile file) {
        ...
        if (!SUPPORTED_MEDIA_TYPES.contains(file.getContentType())) {
            throw new UnsupportedFileTypeException(
                    "Unsupported media type. Supported types are: " + SUPPORTED_MEDIA_TYPES);
        }
