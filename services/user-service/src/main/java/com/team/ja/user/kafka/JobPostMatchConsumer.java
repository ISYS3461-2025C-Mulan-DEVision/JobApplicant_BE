...
// private final UserSearchProfileJobTitleRepository
// userSearchProfileJobTitleRepository;
// private final UserSearchProfileSkillRepository
// userSearchProfileSkillRepository;
// private final UserSearchProfileEmploymentRepository
// userSearchProfileEmploymentRepository;
...
// @KafkaListener(topics = KafkaTopics.JOB_POST_PUBLISHED, groupId =
// "user-jobpost-match-consumer", containerFactory =
// "jobPostingEventKafkaListenerContainerFactory")
// public void handleJobPostPublishedEvent(JobPostingEvent event) {
// log.info("Received JobPostPublishedEvent for processing: jobId={}, title={}",
// event.getJobPostId(),
// event.getTitle());
